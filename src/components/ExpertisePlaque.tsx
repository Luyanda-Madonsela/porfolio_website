 ...
 return (
    <div>
        <div className='flex flex-col w-64 bg-custom-gray rounded-b-lg mb-32'>
            ...
            <Balancer>
                        <p className='flex flex-col h-24 justify-center items-center content-center justify-items-center text-purple font-semibold text-xl'>{headingText}</p>
                        <p className='flex flex-col h-32 pl-4 justify-start items-center content-center text-sm font-semibold text-gray-700 '>{paragraphText}</p>
            </Balancer>
        </div>
    </div>
 );
