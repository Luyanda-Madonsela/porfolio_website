...
const ExpertisePlaque: React.FC<ExpertisePlaqueProps> = ({ imageUrl, headingText, paragraphText }) => {
    return (
        <div>
            <div className='flex flex-col md:w-48 lg:w-48 xl:w-56 bg-custom-gray rounded-b-lg mb-28'>
                <div className='flex h-3 bg-butt-color'></div>

                <div className='flex flex-col p-2 md:m-2 lg:m-2 xl:m-4 relative md:h-44 md:w-44 lg:h-40 lg:w-44 xl:h-56 xl:w-48 justify-center items-center content-center justify-items-center'>
