...
const ProjectPlaque: React.FC<ProjectPlaqueProps> = ({ imageUrl, headingText1, headingText2, imageWidth, imageHeight, button1, button2 }) => {
 return (
    <div>
