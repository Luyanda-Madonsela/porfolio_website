...
const Navigation = () => {
 ...
 return (
    <div className="flex  h-28 md:h-32 w-full pr-12 pl-6 md:pl-14 md:pt-6 mb-5 md:mb-10 font-poppins-500 md:text-md lg:text-lg xl:text-xl relative z-50 justify-between md:justify-normal">
