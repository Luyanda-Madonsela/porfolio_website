...
{/* ------------------------------------------------Hero Section--------------------------------------------------- */}
      <div className=" flex flex-row min-h-0 w-fit items-center content-center justify-center" >

        <div className="flex flex-col lg:gap-1 xl:gap-3 2xl:gap-3 min-h-112 w-1/2 md:pt-2 pt-10 ">
            <Header text="I'm Luyanda Madonsela, a" />
            <div className='text-butt-color font-semibold md:text-xl lg:text-3xl xl:text-5xl'>Full Stack Web &</div>
            <div className='text-butt-color font-semibold md:text-xl lg:text-3xl xl:text-5xl'>Software Developer</div>
            ...
            <div className='text-lg font-semibold text-gray-800'>
              <Button text="View portfolio" href="/portfolio" target='' height="md:h-12 lg:h-12 xl:h-16 2xl:h-16" width="md:w-44 lg:w-44 xl:w-44 2xl:w-44"/>
            </div>
        </div>
        {/* -----------------Hero Image------------- */}
        <div className="flex items-center content-center justify-start min-h-160 w-1/2 md:mb-28 lg:mb-28 xl:mb-10 2xl:mb-10 xl:mr-6 2xl:mr-32 relative md:w-64 md:h-72 lg:w-96 lg:h-96 xl:w-140 xl:h-140">
          <Image
            src={welcome_selfie}
            layout="fill" 
            objectFit="contain"
...
{/* ------------------------------------------------Expertise Section--------------------------------------------------- */}
      <div className="flex flex-col gap-24 h-24 w-full pl-16 pt-18 md:pt-10">
        <Header text="my expertise" />
      </div>
      <div className="flex min-h-112 w-full pt-10 2xl:pt-16 justify-center items-center content-center">
...
{/* ------------------------------------------------Tech Stack Section--------------------------------------------------- */}
      ...
      <div className="flex flex-col md:h-128 lg:h-192 w-full">
        ...
        <div className='flex flex-col h-24 w-full p-16 text-lg font-semibold text-gray-800 justify-center items-center content-center'>
              <Button text="View projects" href="/portfolio" target='' height="md:h-12 lg:h-12 xl:h-12 2xl:h-12" width="md:w-40 lg:w-40 xl:w-40 2xl:w-40"/>
        </div>
