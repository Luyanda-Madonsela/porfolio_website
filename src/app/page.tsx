  ...
  return (
    <main className="flex min-h-screen flex-col ">
      <div className=" flex flex-row min-h-0 w-full items-center content-center justify-center pl-16">
        <div className="flex h-112 w-1/2 border border-red-500"></div>
      ...
      <div className="flex border border-red-500 h-192 w-full">expertise</div>

      <div className="flex border border-red-500 h-192 w-full">tech stack</div>
    </main>
  )
}
